...
if num > 0:
    ...
    print("Error: El numero digitado es 0")
elif num < 0:
        ...
        if edad <= 0:
            ...
            while bandera>0:
                ...
                if pesoNiñ > 0:
                    ...
                    total +=1
                    promNiñ = round((totalPesoNiñ/contNiñ),2)
                    break
                elif pesoNiñ <=0:
            ...
            while bandera >0:
                ...
                if pesoJov > 0:
                    ...
                    total += 1
                    promJov = round((totalPesoJov/contJov),2)
                    break
                elif pesoJov <= 0:
                    print("Error: El peso no es valido")
                    continue
            ...
            while bandera > 0:
                ...
                if pesoAdul > 0:
                    ...
                    total +=1
                    promAdul = round((totalPesoAdul/contAdul),2)
                    break
                elif pesoAdul <= 0:
                    print("Error: El peso no es valido")
                    continue
            ...
            while bandera > 0:
                ...
                if pesoViej > 0:
                    ...
                    total +=1
                    promViej = round((totalPesoViej/contViej),2)
                    break
                elif pesoViej <= 0:
                    print("Error: El peso no es valido")
                    continue
...
while bandera == True:
    ...
    if i == 3:
        ...
        print(f'El empleado {nombre} recibira un valor total de {comision} por comision de las tres ventas semanales, por lo tanto el valor total del sueldo semanal es de {(sueldoBase/4)+comision}')
        bandera == False
        print(" ")
