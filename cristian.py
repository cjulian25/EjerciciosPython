...
Elegir la opcion de operacion '''))
    ...
    match menu:
        ...
        case 3:
            ...
            for i in Coex:
                print(f'el estudiante : {i["Nombre"]} obtuvo un promedio  de : {i["Promedio"]}') 
            
            print(Coex)
    
        case 4:

            for i in Coex: #RESULTADOS COMPLETOS CON NOMBRE Y CODIGO
                print("")
                print(f'El estudiante : {i["Nombre"]} , con el codigo  :{i["Codigo"]} , obvtuvo en su primera mision una nota de : {i["Nota1"]} ,en la segunda {i["Nota2"]} , en la tercera {i["Nota3"]} y en la final : {i["Nota4"]} y su promedio fue de {i["Promedio"]}')
                print("")
